...
training_df = builder.build_synthetic_training_set(n_seasons=14)
ml = MLPredictor(blend_weight=0.35)
ml.train(training_df)
print(f"  ✅ ML trained on {len(training_df)} games")
...
class PredictResponse(BaseModel):
    ...
    home_efficiency: dict = {}
    away_efficiency: dict = {}
...
def predict_game(req: PredictRequest):
    ...
    return PredictResponse(
        ...
        adjustments={
            ...
            "total": round(result.total_adjustment, 2),
        },
